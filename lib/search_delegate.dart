...
class ProductSearchDelegate extends SearchDelegate {
  ...
  Widget _buildProductCard(BuildContext context, Product product) {
    final imageUrl = (product.imageUrl.isNotEmpty) ? (product.imageUrl.first) : null;
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () {
          appLogger.i('SearchResult.onTap - productId: ${product.id}');
          // Navigator.push(
          //   context,
          //   MaterialPageRoute(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        if (product.salePrice.isNotEmpty) const SizedBox(width: 8),
                        if (product.salePrice.isNotEmpty)
                          Text(
                            '₹${product.price}',
                            style: const TextStyle(
  ...
  Widget buildSuggestions(BuildContext context) {
    final suggestions = query.trim().isEmpty
        ? allProducts.take(10).toList() // top 10 suggestions when query empty
